    ...
    <div className={`${themeClasses} min-h-screen ${bgClass} transition-colors duration-300`}>
      ...
      <div className="fixed top-4 right-4 z-50 space-y-2">
        {notifications.map(notification => (
          ...
          >
            ...
            {notification.message && <div className="text-xs">{notification.message}</div>}
          </div>
        ))}
      </div>
      ...
      <div className="flex pt-16">
        ...
        <main className="flex-1 p-6 lg:ml-0">
          ...
          {/* Other sections - simplified versions */}
                ...
                {scanHistory.length > 0 ? scanHistory.map((scan, index) => (
                  <div key={index} className="p-4 border-b border-slate-700 last:border-b-0">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-green-400">{scan.findings.length} findings</span>
                    </div>
                  </div>
                )) : (
            ...
            <div className="space-y-6">
              ...
              <div className={`${cardClass} border rounded-xl p-6`}>
                <div className="text-center py-8">
                  ...
                  <button 
                    onClick={() => notify.info('Coming Soon', 'Report generation feature is under development')}
                    className="bg-green-500 hover:bg-green-600 px-4 py-2 rounded-lg font-semibold transition-colors"
                  >
                    Generate Report
                  </button>
